...
`curry` lets us call a function in stages. If all the arguments have been given the function will execute, otherwise it will return a new curried function ready to take the rest of the arguments.
